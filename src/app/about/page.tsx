...
export const metadata: Metadata = {
  title: "About",
  description:
    "Learn how One Chicago Roster works, where episode order data comes from, and how to contribute timeline corrections to the community spreadsheet.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
...
export default function AboutPage() {
  ...
  return (
    <>
      <StructuredData data={buildAboutPageJsonLd()} />
